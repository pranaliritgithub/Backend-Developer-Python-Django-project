...
urlpatterns = [
    ...
    # Update routes using MongoDB _id (as string)
    path('update_furniture/<str:id>/', views.update_furniture, name='update_furniture'),
    path('delete_furniture/<str:id>/', views.delete_furniture, name='delete_furniture'),
